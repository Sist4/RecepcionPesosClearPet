    ...
    public partial class VConfiguracion : Form
    {
        ...
        public void CargarConfiguracion()
        {
            ...
            txtMConfiguracionPiso.Text = "Serial: " + controlador.ObtenerSerialPiso() + "\n" +
                               ...
                               "Bits de parada: " + "1" + "\n" +
                               "Control de flujo: " + "Ninguno" + "\n";
            txtCiudad.Text = controlador.ObtenerCiudad();
            txtRUC.Text = controlador.ObtenerRUC();
            txtDireccion.Text = controlador.ObtenerDIR();
        }
        ...
        {
            if(!txtRUC.Text.Equals(string.Empty) || !txtDireccion.Text.Equals(string.Empty) || !txtCiudad.Text.Equals(string.Empty))
            {
                controlador.ActualizarInformacionTicket(txtRUC.Text,txtDireccion.Text,txtCiudad.Text);
