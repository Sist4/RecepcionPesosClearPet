...
create table CONFIGURACION (
   ...
   CON_RUC              varchar(MAX)         null,
   CON_DIR              varchar(MAX)         null,
   CON_CIUDAD           VARCHAR(MAX)         null,
...
INSERT [dbo].[CONFIGURACION] ([CON_ID], [CON_COMCAMIONERA], [CON_SERIALCAMIONERA], [CON_COMPISO], [CON_SERIALPISO],[CON_RUC],[CON_DIR],[CON_CIUDAD]) VALUES (1, N'', N'', N'', N'',N'',N'',N'')
GO
